            ...
            <div className="flex items-center justify-between gap-4">
              <div>
                ...
                <CardDescription className="mt-1">
                  Defina os aportes que serão usados para reduzir o
                  prazo.
                </CardDescription>
              </div>
                ...
                <Card className="rounded-2xl shadow-sm">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between gap-4">
                      ...
                      <span className="font-medium">
                        {formatCurrency(
                          result.scenario.totalExtraPaid,
                        )}
                      </span>
                    </div>
              ...
              <div className="flex items-start gap-3 rounded-2xl border border-amber-200 bg-amber-50 p-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-amber-800">
                    O cálculo usa o sistema Price, mantém a
                    prestação-base e direciona todas as amortizações
                    para redução de prazo. Seguros, taxa administrativa,
                    alterações contratuais e TR futura não estão
                    incluídos quando o campo de TR permanece em zero.
                  </p>
                </div>
              </div>
            </>
