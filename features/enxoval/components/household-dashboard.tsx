...
export function HouseholdDashboard({
  ...
  const [listTypeFilter, setListTypeFilter] =
    useState<HouseholdListType | "all">(
      "all",
    );
      ...
      <Card className="rounded-2xl shadow-sm">
          ...
          <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-start">
            <div>
              ...
              <CardDescription className="mt-1">
                Compras e presentes recebidos em
                relação às quantidades desejadas.
              </CardDescription>
            </div>

            <Badge className="bg-emerald-100 text-emerald-950">
              {data.completedItems} de{" "}
              {data.totalItems} itens completos
            </Badge>
          </div>
        </CardHeader>
        ...
        <CardContent>
          ...
          <div className="mt-5 grid gap-4 sm:grid-cols-3">
            ...
            <div className="rounded-xl border p-4">
              <p className="text-sm text-slate-500">
                Custo pendente estimado
              </p>

              <p className="mt-2 text-xl font-semibold">
                {formatCurrency(
                  data.estimatedPendingCost,
                )}
              </p>
            </div>
          </div>
        ...
        <CardHeader className="flex flex-col justify-between gap-5 md:flex-row md:items-start">
          <div>
            ...
            <CardDescription className="mt-2">
              Organize itens necessários, compras
              próprias e presentes recebidos.
            </CardDescription>
          </div>
