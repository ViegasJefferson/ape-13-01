    ...
    >
      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Registre itens do enxoval, compras
            planejadas e presentes recebidos.
          </DialogDescription>
        </DialogHeader>
        ...
        >
          <div className="grid gap-5 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              <Label
                htmlFor={`estimated-${item?.id ?? "new"}`}
              >
                Valor unitário estimado
              </Label>

              <Input
                id={`estimated-${item?.id ?? "new"}`}
            ...
            <div className="space-y-2">
              <Label
                htmlFor={`store-${item?.id ?? "new"}`}
              >
                Loja
              </Label>

              <Input
                id={`store-${item?.id ?? "new"}`}
                name="storeName"
                defaultValue={
                  item?.storeName ?? ""
                }
